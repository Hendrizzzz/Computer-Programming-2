/**
 HANDLING IT IN THE SAME METHOD

 One way to deal with Exception is to handle the Exception when it occurs by using the try-catch statement.
...
public class ExceptionDemo2{
     ...
     *A method that returns an integer read from the input device.
     1. Let a result represent the integer read from input device
     ...
     ( Note that the parseInt method generates an exception if it is given a string that
     cannot
     be converted to an integer.)
     If no exception is generated, assign the integer to result
     Assign true to validValueRead
     else
     Give a helpful message for the user to enter a valid integer and repeat from step
     4. Return result.
     **/
    ...
    /* The probable Exception in the following method is handled */
